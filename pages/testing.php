...
//    var_dump($_SESSION['testing']['stage']);
    ...
    <form method="post">
        <input type="number" id="testing_before" name="testing_before" placeholder="Показатель сердцебиения" style="width: 20%; font-size: 24px; height: 30px;">
        <br><button class="button" type="submit" style="width: 20%">Пройти тестирование</button>
    </form>
    ...
    <form method="post">
        <input type="number" id="testing_during" name="testing_during" placeholder="Показатель сердцебиения во время тестирования" style="width: 20%; font-size: 24px; height: 30px;">

        <p>После тестирования:</p>
        <input type="number" id="testing_after" name="testing_after" placeholder="Показатель сердцебиения во время тестирования" style="width: 20%; font-size: 24px; height: 30px;">

        <br><button type="submit" class="button" style="width: 20%">Завершить тестирование</button>
    </form>
