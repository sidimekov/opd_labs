...
<div class="main">
    ...
    <div class="button-container">
        ...
        <p class="attention-instructions" id="attention-instructions">Нажмите на нужную ячейку</p>
        <button class="attention-start-button" id="attention-start-button">Нажмите, чтобы начать тест</button>
